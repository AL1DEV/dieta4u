...
?>
<div id="field-slideshow-<?php print $slideshow_id; ?>-wrapper" class="field-slideshow-wrapper <?php print $class; ?>">
    ...
    <div class="<?php print $classes; ?>" style="<?php print $style; ?>">
        <?php foreach ($items as $num => $item) : ?>
            <div class="<?php print $item['classes']; ?>"<?php if ($num) : ?> style="display:none;"<?php endif; ?>>
                <?php $img =  substr_replace($item['image'], '<a data-fancybox=images', 0, 2);?>
                <?php print $img; ?>
